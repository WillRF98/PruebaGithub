<?php
    ...
    class Usuario{
        ...
        // public function Loguearse($dui, $pass){
        //     $sql = "SELECT * FROM usuario 
        //         inner join tipo_us on us_tipo=id_tipo_us
        //         where dui_us=:dui and contrasena_us=:pass";
        ...
        public function Loguearse($dui, $pass){
            $sql = "SELECT * FROM usuario inner join tipo_us on us_tipo=id_tipo_us where dui_us=:dui";
            $query = $this->acceso->prepare($sql);
        ...
        public function obtener_dato_logueo($user){
            $sql = 'SELECT * FROM usuario 
