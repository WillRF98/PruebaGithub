                                ...
                                <div class="row">
                                    <div class="col-7">
                                        ...
                                        <ul class="ml-4 mb-0 fa-ul">
                                            <li class="small"><span class="fa-li"><i class="fas fa-prescription-bottle"></i></span> Concentración: ${lote.concentracion}</li>
                                            <li class="small"><span class="fa-li"><i class="fab fa-cc-paypal"></i></span>${lote.adicional}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-receipt"></i></span>Marca: ${lote.laboratorio}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-clinic-medical"></i></span> Tipo: ${lote.tipo}</li>
                                            <li class="small"><span class="fa-li"><i class="fas fa-dice-d6"></i></span> Presentacion: ${lote.presentacion}</li>
