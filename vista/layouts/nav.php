    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav container justify-content-center">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="adm_catalogo.php" class="nav-link">Productos</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Ejercicio</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Dieta</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../vista/adm_catalogo.php" class="brand-link">
                <img src="../img/logo5.png" alt="Admin Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
...
-->
                        ...
                        <li class="nav-item" id="gestion_proveedor">
