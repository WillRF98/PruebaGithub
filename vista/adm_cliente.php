                        ...
                        <div class="card-body">
                            ...
                            <form id="form-crear">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="dui"  type="text" class="form-control" placeholder="Ingrese DUI">
                                </div>
                                <div class="form-group">
                                    <label for="nacimiento">Edad</label>
                                    <input id="nacimiento"  type="date" class="form-control" placeholder="Ingrese fecha de nacimiento">
                                </div>
                                <div class="form-group">
