                            ...
                            <div class="card">
                                <div class="card-header">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a href="#laboratorio" class="nav-link active" id="home-tab" data-toggle="tab" role="tab" aria-controls="home" aria-selected="true" data-toggle="tab">Marca</a>
                                        </li>
                                        <tr>
                                        <li class="nav-item">
                                            <a href="#tipo" class="nav-link" id="profile-tab" data-toggle="tab" role="tab" aria-controls="profile" aria-selected="false">Tipo</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#presentacion" class="nav-link" id="contact-tab" data-toggle="tab"  role="tab" aria-controls="contact" aria-selected="false">Presentacion</a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="card card-info">
                                                <div class="card-header">
                                                    <div class="card-title">                                                    
                                                        ...
                                                        Buscar Marcas 
                                                        <button class="btn bg-gradient-dark btn-sm m-2" type="button" data-toggle="modal" data-target="#crearlaboratorio">
                                        ...
                                        <div class="tab-pane" id="tipo">
                                            <div class="card card-info">
                                                <div class="card-header">
                                                    <div class="card-title">
                                                        Buscar tipo
                                                        <button class="btn bg-gradient-dark btn-sm m-2" type="button" data-toggle="modal" data-target="#creartipo">
                                                            <i class="fas fa-plus"></i>
                                                        </button>
                                                    </div>
                                                    <div class="input-group">
                                        ...
                                        <div class="tab-pane" id="presentacion">
                                            <div class="card card-info">
                                                <div class="card-header">
                                                    <div class="card-title">
                                                        Buscar presentacion
                                                        <button class="btn bg-gradient-dark btn-sm m-2" type="button" data-toggle="modal" data-target="#crearpresentacion">
                                                            <i class="fas fa-plus"></i>
                                                        </button>
                                                    </div>
                                                    <div class="input-group">
