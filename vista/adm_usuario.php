                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="text-center">
                            <img id="avatar2" src="../img/avatar2.png" alt="avatar2" class="profile-user-img img-fluid img-circle">
                        </div>
                        <div class="text-center">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>
                                Gestion usuarios
                                <button id="btn_crear" type="button" data-toggle="modal" data-target="#crear_usuario" class="btn bg-gradient-info ml-2">Crear usuario</button>
                            </h1>
