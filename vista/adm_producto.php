                    ...
                    <div class="card-info">
                        ...
                        <div class="card-body">
                            ...
                            <form id="form-crear-producto">
                                <div class="input-group mb-3" title="Ingresar nombre del produc">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-signature"></i></span>
                                    </div>
                                ...
                                <div class="input-group mb-3" title="Ingresar Codigo Paypal">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fab fa-cc-paypal"></i></span>
                                    </div>
                                    <input id="adicional" type="text" class="form-control" placeholder="Ingrese Codigo Paypal">
                                </div>
                                ...
                                <div class="input-group mb-3" title="Marca">
                                    <div class="input-group-prepend">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-8">
                            ...
                            <!-- id="btn_reporte" -->
                                Gestion productos
                                <button id="btn_crear" type="button" data-toggle="modal" data-target="#crear_producto" class="btn bg-gradient-info ml-2">Crear producto</button>
